...
\@pvspace{8.0pt}%
 \@x{ Msgs \.{\defeq} {\langle} M\_read ,\, M\_read\_resp ,\, M\_lock ,\,
...
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
 \@x{\@s{8.2} \.{\land} Replicas \.{=} [ r \.{\in} RIDs \.{\mapsto} [ locked
 \.{\mapsto} {\FALSE} ,\, version \.{\mapsto}\@w{Init} ,\, logged
 \.{\mapsto}\@w{NULL} ] ]}%
...
\@x{\@s{8.2} \.{\land} Coordinator\_state [ t ] \.{=}\@w{Start}}%
 ...
 \@x{\@s{8.2} \.{\land} {\UNCHANGED} {\langle} M\_read\_resp ,\, M\_lock ,\,
 M\_lock\_resp ,\, M\_unlock ,\, M\_unlock\_resp {\rangle}}%
...
\@x{\@s{8.2} \.{\land} \E\, m \.{\in} M\_read \.{:}}%
 ...
 [ src \.{\mapsto} r ,\, dst \.{\mapsto} m . src ,\, ver \.{\mapsto} Replicas
 [ r ] . version ] \}}%
 \@x{\@s{19.31} \.{\land} {\UNCHANGED} {\langle} M\_read ,\, M\_lock ,\,
 M\_lock\_resp ,\, M\_unlock ,\, M\_unlock\_resp {\rangle}}%
 \@x{\@s{8.2} \.{\land} {\UNCHANGED} {\langle} Replicas ,\, Coordinator\_state
...
\@x{\@s{8.2} \.{\land} Coordinator\_state [ t ] \.{=}\@w{Read}}%
 ...
 \@x{\@s{34.52} k \.{\in} Txns [ t ] \.{\mapsto} ( {\CHOOSE} m \.{\in}
 M\_read\_resp \.{:} m . dst \.{=} t \.{\land} m . src \.{=} F [ k ] ) . ver}%
\@x{\@s{34.52} ] ]}%
 \@x{\@s{8.2} \.{\land} Coordinator\_state \.{'} \.{=} [ Coordinator\_state
 {\EXCEPT} {\bang} [ t ] \.{=}\@w{Lock} ]}%
 \@x{\@s{8.2} \.{\land} {\UNCHANGED} {\langle} Replicas ,\, Msgs ,\,
 Linearisability\_rt {\rangle}}%
\@pvspace{8.0pt}%
\@x{ CoordinatorLock ( t ) \.{\defeq}}%
\@x{\@s{8.2} \.{\land} Coordinator\_state [ t ] \.{=}\@w{Lock}}%
 \@x{\@s{8.2} \.{\land} M\_lock \.{'} \.{=} M\_lock \.{\cup} \{ [ tid
 \.{\mapsto} t ,\, txn \.{\mapsto} Txns [ t ] ,\, state \.{\mapsto}
 Coordinator\_txn\_state [ t ] ] \}}%
 \@x{\@s{8.2} \.{\land} {\UNCHANGED} {\langle} M\_read ,\, M\_read\_resp ,\,
 M\_lock\_resp ,\, M\_unlock ,\, M\_unlock\_resp {\rangle}}%
 \@x{\@s{8.2} \.{\land} Coordinator\_state \.{'} \.{=} [ Coordinator\_state
...
\@pvspace{8.0pt}%
 ...
 Coordinator\_state ,\, Coordinator\_txn\_state ,\, Msgs ,\,
 Linearisability\_rt {\rangle}}}%
\@pvspace{8.0pt}%
\@x{ Serialisability ( C ) \.{\defeq}}%
...
\@pvspace{8.0pt}%
 ...
 \.{=}\@w{Abort} \}}%
\@pvspace{8.0pt}%
\@x{ Safety\_non\_recovery \.{\defeq} Serialisability ( CommittedTIDs )}%
\@x{}\bottombar\@xx{}%
\end{document}
