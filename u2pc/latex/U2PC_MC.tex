...
\@x{ T1 \.{\defeq} SetAsFun ( \{ Pair (\@w{T1} ,\, \{\@w{X} \} ) \} )}%
 ...
 (\@w{T2} ,\, \{\@w{X} \} ) \} )}%
 \@x{ S1\@s{1.66} \.{\defeq} SetAsFun ( \{ Pair (\@w{X} ,\, \{\@w{X1}
 ,\,\@w{X2} \} ) \} )}%
\@pvspace{8.0pt}%
 \@x{ T3 \.{\defeq} SetAsFun ( \{ Pair (\@w{T1} ,\, \{\@w{X} ,\,\@w{Y} \} )
 ,\, Pair (\@w{T2} ,\, \{\@w{Y} ,\,\@w{Z} \} ) ,\, Pair (\@w{T3} ,\, \{\@w{Z}
 ,\,\@w{X} \} ) \} )}%
 \@x{ S3\@s{1.66} \.{\defeq} SetAsFun ( \{ Pair (\@w{X} ,\, \{\@w{X1}
 ,\,\@w{X2} \} ) ,\, Pair (\@w{Y} ,\, \{\@w{Y1} ,\,\@w{Y2} \} ) ,\, Pair
 (\@w{Z} ,\, \{\@w{Z1} ,\,\@w{Z2} \} ) \} )}%
\@pvspace{16.0pt}%
\@x{ CInit \.{\defeq}}%
...
\@x{ TransitiveClosure ( R ) \.{\defeq}}%
 ...
 \{ r [ 2 ] \.{:} r \.{\in} R \}}%
\@x{\@s{28.59} {\RECURSIVE} TCR ( \_ )}%
\@x{\@s{32.69} TCR ( T ) \.{\defeq} {\IF} T \.{=} \{ \}}%
\@x{\@s{98.04} \.{\THEN} R}%
 \@x{\@s{98.04} \.{\ELSE} \.{\LET} r \.{\defeq} {\CHOOSE} s \.{\in} T \.{:}
 {\TRUE}}%
\@x{\@s{153.85} RR \.{\defeq} TCR ( T \.{\,\backslash\,} \{ r \} )}%
 \@x{\@s{129.35} \.{\IN}\@s{4.10} RR \.{\cup} \{ {\langle} s ,\, t {\rangle}
 \.{\in} S \.{\times} S \.{:}}%
 \@x{\@s{188.83} {\langle} s ,\, r {\rangle} \.{\in} RR \.{\land} {\langle} r
 ,\, t {\rangle} \.{\in} RR \}}%
...
\@x{\@s{8.2} \{ t \.{\in} TIDs \.{:}}%
\@x{\@s{17.30} \A\, r \.{\in} S \.{:}}%
\@x{\@s{17.30} KeyLookup [ r ] \.{\in} Txns [ t ]}%
 \@x{\@s{17.30} \.{\implies} \.{\lor} Replicas [ r ] . locked \.{\land}
 Replicas [ r ] . logged \.{=} t}%
\@x{\@s{32.85} \.{\lor} Replicas [ r ] . version \.{=} t}%
 \@x{\@s{32.85} \.{\lor} {\langle} t ,\, Replicas [ r ] . version {\rangle}
...
\@x{\@s{8.2} \{ t \.{\in} TIDs \.{:}}%
\@x{\@s{17.30} \E\, r \.{\in} S \.{:}}%
\@x{\@s{17.30} \.{\land} KeyLookup [ r ] \.{\in} Txns [ t ]}%
\@x{\@s{17.30} \.{\land} \.{\lor} {\lnot} Replicas [ r ] . locked}%
 \@x{\@s{28.41} \.{\lor} Replicas [ r ] . locked \.{\land} Replicas [ r ] .
 logged \.{\neq} t \}}%
\@pvspace{8.0pt}%
\@x{ Durability \.{\defeq}}%
\@x{\@s{8.2} \A\, S \.{\in} {\SUBSET} RIDs \.{:}}%
